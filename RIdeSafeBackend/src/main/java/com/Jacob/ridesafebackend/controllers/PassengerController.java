...
public class PassengerController {
	...
	public PassengerController(PassengerService passengerServ) {
    ...
    public ResponseEntity<?> getPassengerById(@PathVariable("id") String id) {	// Pass in the drivers Id to send to the frontend
